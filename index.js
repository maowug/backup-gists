...
const getCurrentPage = (currentPage) => {
  r.get({
    url: conf.domain
    ? `http://${conf.username}:${conf.password}@${conf.domain}/api/v3/users/${conf.username}/gists?page=${currentPage}&per_page=100`
    : `https://${conf.username}:${conf.password}@api.github.com/users/${conf.username}/gists?page=${currentPage}&per_page=100`,
    json: true,
    headers: {
    ...
    console.log(chalk.green(`Download page: ${currentPage}.`))
